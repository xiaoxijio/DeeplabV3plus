...
class DeepLabHeadV3Plus(nn.Module):
    ...
    def forward(self, feature):
        # print(feature.shape)  # return_layers = {'layer4': 'out', 'layer1': 'low_level'}
        ...
        # print(output_feature.shape)  # 拼接+3*3卷积+bn+relu+1*1卷积
...
class ASPP(nn.Module):
    def __init__(self, in_channels, atrous_rates):
        ...
        modules.append(ASPPPooling(in_channels, out_channels))  # 第五个 pooling+1*1卷积+bn+relu
