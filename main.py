...
from network.deeplab import convert_to_separable_conv
from utils import ext_transforms as et
from network.modeling import deeplabv3_mobilenet, deeplabv3plus_mobilenet, deeplabv3plus_resnet50, deeplabv3_resnet50, \
    deeplabv3_resnet101, deeplabv3plus_resnet101
from utils.scheduler import PolyLR
from utils.stream_metrics import StreamSegMetrics
from utils.utils import set_bn_momentum, mkdir, Denormalize
...
def get_argparser():
    ...
    parser.add_argument("--val_interval", type=int, default=100, help="epoch interval for eval")
...
def main():
    ...
    if opts.separable_conv and 'plus' in opts.model:
        convert_to_separable_conv(model.classifier)  # 会将单个标准卷积替换为深度可分离卷积(深度卷积+逐点卷积)
